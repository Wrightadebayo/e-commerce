  ...
  return (
    ...
    className="h-screen grid place-items-center">
      ...
      shadow-lg flex flex-col gap-y-4">
        <h4
         className="text-center text-3xl capitalize
          font-bold">Register</h4>
        ...
        <FormInput
         ...
         label="username"
          name="username" 
          defaultValue='wright2 smith' />

        {/* FormInput for email */}
        <FormInput 
        type="email" 
        label="email"
         name="email" defaultValue='wright2@gmail.com'
          
         />

        {/* FormInput for password */}
        <FormInput 
        type="password" 
        label="password"
         name="password"
